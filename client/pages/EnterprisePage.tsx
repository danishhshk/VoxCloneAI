  ...
  return (
    <div className="max-w-4xl mx-auto py-4 sm:py-8 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6 sm:mb-8">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold">Enterprise Solutions</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 mb-8 sm:mb-12">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-4 sm:p-6 border border-slate-100 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            <button
              type="submit"
              disabled={loading}
              className={`w-full sm:w-auto px-4 py-2 rounded-lg font-bold text-white ${loading ? 'bg-slate-300' : 'bg-indigo-600 hover:bg-indigo-700'}`}
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-4 py-2 rounded-lg border border-slate-200 text-sm"
            >
              Reset
            </button>
          </div>
